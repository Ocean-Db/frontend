    ...
    <div className="md:flex md:mx-20">
      <div className="p-5 md:my-10 md:w-[55%]">
        <h1 className="p-2 text-[1.8rem] md:text-[3rem] font-semibold">
          Cross-Platfrom <br /><span className="text-blue-500">Database</span>{" "}
          <br />Management &<br /> Excel Integration
        </h1>
      ...
      <div className="flex align-bottom md:w-[45%]"><Image src="/svg.png" width={1000} height={1000} style={{objectFit: "contain"}} className="" alt="svg"/></div>
    </div>
  );
};
